...
class PCA_convexhull:
    ...
    def __init__(self, data, Type, figsize, savefig = False):
        self.data = data
        self.ID = self.data.columns[3]
        self.Type = Type
    ...
    def AD_PCA(self):
        ...
        #display(self.df_test[self.df_test['convex']==False].head())
        self.index_out =  self.df_test[self.df_test['convex']==False].reset_index(drop=True).index
    ...
    def Visualize(self):
        ...
        if self.savefig == True:
            ...
            plt.savefig('AD_img/pca_convex_hull.png', dpi = 300)
